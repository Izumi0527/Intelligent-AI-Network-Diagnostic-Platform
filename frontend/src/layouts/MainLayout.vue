...
const logoSvg = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="2" width="20" height="20" rx="5" fill="currentColor" fill-opacity="0.06" stroke="currentColor" stroke-width="1.2"/><circle cx="7" cy="7" r="1.5" fill="currentColor"/><circle cx="17" cy="7" r="1.5" fill="currentColor"/><circle cx="7" cy="17" r="1.5" fill="currentColor"/><circle cx="17" cy="17" r="1.5" fill="currentColor"/><circle cx="12" cy="12" r="2" fill="currentColor"/><line x1="7" y1="7" x2="12" y2="12" stroke="currentColor" stroke-width="0.7"/><line x1="17" y1="7" x2="12" y2="12" stroke="currentColor" stroke-width="0.7"/><line x1="7" y1="17" x2="12" y2="12" stroke="currentColor" stroke-width="0.7"/><line x1="17" y1="17" x2="12" y2="12" stroke="currentColor" stroke-width="0.7"/></svg>';
